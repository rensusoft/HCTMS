...
<head>
	...
	<link rel="stylesheet" href="<tm:ctx/>/jsp/web/teach/css/stuState.css"/>
	...
	<script src="<tm:ctx/>/jsp/web/teach/js/stuState.js"></script>
</head>
<body>
    <ul class="state">
        <li onclick="getAttendState(1);"><a>已考勤</a></li>
        <li onclick="getAttendState(0);"><a>未考勤</a></li>
    </ul>
</body>
</html>