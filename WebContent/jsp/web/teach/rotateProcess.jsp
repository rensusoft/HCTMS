...
<head >
	...
	<link rel="stylesheet" href="<tm:ctx/>/jsp/web/teach/css/rotateProcess.css"/>
	   <script src="<tm:ctx/>/jsp/web/teach/js/rotateProcess.js"></script>
</head>
<body>
<div class="section_list" id="leftDiv">
</div>
<iframe name="rotateProcessRight" src="<tm:ctx/>/jsp/web/teach/rotateProcessRight.jsp" frameborder="0" style="width:82%;float: right;height:100%;">
</iframe>
</body>
</html>
