...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="<tm:ctx/>/jsp/web/teach/js/homeworkContEdit.js"></script>
    <!-- ueditor核心js -->
...
<body>
      <div class="newsCont">
        ...
        <textarea name="contents" id="contents" cols="30" rows="10" style="margin-top:4px;width:100%;height:250px;padding-bottom:20px;"></textarea><br/>
