...
<head>
	...
	<link rel="stylesheet" href="<tm:ctx/>/jsp/web/teach/css/reviewDailyRecord.css"/>
	...
	<script type="text/javascript" src="<tm:ctx/>/jsp/web/teach/js/reviewDailyRecord.js"></script>
</head>
<body>
    <div style="margin: 5px 0px 0px 20px;">
        <table id="dailyRecord"></table>
        <div id="pager1"></div>
    </div>
    <div class="btn_group">
        <a class="layui-layer-btn0" onclick="batchReview()">批量审阅</a>
    </div>
</body>
</html>