...
<head lang="en">
   ...
   <link rel="stylesheet" type="text/css" media="screen" href="<tm:ctx/>/css/jqgrid/redmond/jquery-ui-1.8.16.custom.css" />
    ...
    <script src="<tm:ctx/>/jsp/web/teach/js/medicalDocumentEdittwo.js"></script>
</head>
<body>
  <section>
    <div class="leftBtn">
    <span id="role_code" style="display:none">${LOGIN_INFO.vUserDetailInfo.role_code}</span>
