...
<head>
	...
	<link rel="stylesheet" href="<tm:ctx/>/jsp/web/teach/css/QRCode.css"/>
	...
	<script src="<tm:ctx/>/jsp/web/teach/js/jquery.qrcode.min.js"></script>
	<script src="<tm:ctx/>/jsp/web/teach/js/QRCode.js"></script>
</head>
<body style="overflow:hidden">
    <section>
        <div class="QRCodeDiv" >
            ...
            <div class="timeDiv">
                <!-- 剩余有效时间：<span id="active_time">59:59</span> -->
            </div> 
            <div class="btns">
