...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<tm:ctx/>/jsp/web/score/css/indeptEduc_M.css" />
    ...
    <script type="text/javascript" src="<tm:ctx/>/jsp/web/score/js/indeptEduc_M.js"></script>
</head>
<body>
	<div class="dtlBox">
	<div id="htmlDiv">
