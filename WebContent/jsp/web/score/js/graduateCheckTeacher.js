	...
	doAjax(url,postData,2,function success(res){
	    ...
	    $("#tabled .stuInfor").hover(
	     ...
	     $(".aBtn").click(function(){
	    		 ...
	    		 mypopdiv(2,"出科审核",'1200px',(pHeight-20)+"px",'','','N',encodeURI(ctx+'/jsp/web/score/evaluateTeacher.jsp?stuId='+stuId+'&train_dept_id='+train_dept_id+'&s_stu_type_id='+s_stu_type_id+'&stuName='
