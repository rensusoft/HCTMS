...
<tm:jsandcss/>
   ...
   <script type="text/javascript" src="<tm:ctx/>/js/My97DatePicker/WdatePicker.js"></script>
    <script src="<tm:ctx/>/jsp/web/index/js/secretaryIndex.js"></script>
        ...
        <li>
            <div class="list_p">
                ...
                <i class="bg_img"><img src="<tm:ctx/>/jsp/web/index/images/students.png"/></i>
                    ...
                    <a style="display:inline-block;border-bottom:1px solid #ddd;vertical-align:bottom;" class="aLine">待入科学生数:<b id="enrollStuCounts" class="orangeNum"></b>人</a><br/>
                    <a style="display:inline-block;border-bottom:1px solid #ddd;vertical-align:bottom;" class="aLine">轮转中学生数:<b id="stuCount" class="orangeNum" ></b>人</a><br/>
                    <a style="display:inline-block;vertical-align:bottom;" class="aLine">待出科学生数:<b id="gradStuCount" class="orangeNum"></b>人</a><br/>
                  </span>  
                    </b>
				...
				<p onclick="shuJu()" style="cursor:pointer;">
                    ...
                    <b>
                        <span><a id="dataAudit" style="color:#E6821B"></a></span>
                        <span>数据审核</span>
                    </b>
                </p>              
            </div>
        ...
        <li>
            <div class="list_p">
                <p onclick="chuKe()" style="cursor:pointer;"> 
                  ...
                  <p onclick="qingJia()"  style="cursor:pointer; ">
                    <i class="bg_img"><img src="<tm:ctx/>/jsp/web/index/images/leave1.png"/></i>                
                    <b>
                        <span><a id="approvalNum" style="color:#E6821B"></a></span>
                        <span>请假审核</span>
                    </b>
                </p>
            </div>
