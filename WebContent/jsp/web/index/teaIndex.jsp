...
<tm:jsandcss/>
   ...
   <script type="text/javascript" src="<tm:ctx/>/js/My97DatePicker/WdatePicker.js"></script>
    <script src="<tm:ctx/>/jsp/web/index/js/teaIndex.js"></script>
    ...
    <div class="bottom_content">
        ...
        <div class="atten_img">
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="studentDetails" style="height:87%;overflow:auto;">      
                </div>
            </div>
        </div>
    </div>
