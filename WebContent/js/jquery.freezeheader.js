...
$(function(){
   var TABLE_ID = 0;
    $.fn.freezeHeader = function (params) {
        ...
        function cloneHeaderRow(obj) {
            ...
            obj.container.find('th').each(function (index) {
                var cellWidth = obj.grid.find('th').eq(index).width()+16;
                $(this).css('width', cellWidth);
            });
            obj.container.css('z-index','9999');
    ...
    $('.table1').freezeHeader({ 'height': '595px' });
    $('.table').freezeHeader();
    $('.table2,.table3').freezeHeader({ 'height': '290px' });
    $('.table4').freezeHeader({ 'height': '490px' });
    $('.table5').freezeHeader({ 'height': '275px' });
    $('.table6').freezeHeader({ 'height': '420px' });
    $('.table7').freezeHeader({ 'height': '286px' });
    $('.table8').freezeHeader({ 'height': '340px' });
    $('.table9').freezeHeader({ 'height': '250px' });
    $('.table10').freezeHeader({ 'height': '330px' });
});
