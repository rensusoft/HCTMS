(function($) {
    $.fn.timepicki = function(options) {
        ...
        return this.each(function() {
            ...
            ele_par.append("<div class='timepicker_wrap'><div class='arrow_top'></div><div class='time'><div class='prev-icon'></div><div class='ti_tx'></div><div class='next-icon'></div></div><div class='mins'><div class='prev-icon'></div><div class='mi_tx'></div><div class='next-icon'></div></div><div class='meridian'><div class='prev-icon'></div><div class='mer_tx'></div><div class='next-icon'></div></div></div>");
            ...
            var cur_next = ele_next.find(".next-icon");
            var cur_prev = ele_next.find(".prev-icon");
