...
jQuery.fn.daterangepicker = function(settings){
	...
	$('.dateRange').append($('.ui-daterangepickercontain'));
	if(options.posX){
		rp.parent().css('left', options.posX);
	}
	if(options.posY){
		rp.parent().css('top', '28px');
	}
